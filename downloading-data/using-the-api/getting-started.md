...
| `/materials/alloys`                             | AlloyPairDoc               | Suggested pairs of materials for alloys based on phase stability.                                                                                                                           |
...
| `/materials/core`                               | MaterialsDoc               | High level materials information. Most users should focus on `/materials/summary` unless more detailed information on the individual `tasks` used is needed.                                |
...
| `/molecules/assoc`                              | MoleculeDoc                | "Associated molecules" used during build molecular data. Users should use `/molecules/summary/` instead.                                                                                    |
