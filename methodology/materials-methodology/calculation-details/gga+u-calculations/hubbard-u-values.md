...
| Ni      | Oxides | $$\text{Li}_2 \text{O} + 2\text{NiO} + 1/2 \text{O}_2 \rightarrow 2 \text{LiNiO}_2$$                                                                                                                | $$\text{Ni}^{2+} \rightarrow \text{Ni}^{3+}$$                                                                                                           | 6.2               | Binary formation energies are not readily available for Ni. The Ni U calibration was performed using a ternary oxide formation energy.[\[5\]](hubbard-u-values.md#references) |
