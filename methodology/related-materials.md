...
* $$\text{Ca(CoS}_2\text{)}_2$$$\ce{Ca(CoS2)2}$-spinel ([mvc-12728](https://materialsproject.org/materials/mvc-12728/)) vs. $$\text{Si(CdO}_2\text{)}_2$$-spinel ([mp-560842](https://materialsproject.org/materials/mp-560842/)) $$\rightarrow$$ _d_ = 0.8877
